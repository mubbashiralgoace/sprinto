...
import { WorkTypeIcon } from '@/features/tasks/components/work-type-icon';
                ...
                <Card className="rounded-lg shadow-none transition hover:opacity-75">
                  <CardContent className="p-4">
                        <div className="flex items-center gap-x-2">
                          ...
                          <p className="truncate text-sm font-medium">{formatTaskTitle(task)}</p>
                        </div>
                      ...
                      <div aria-hidden className="size-1 rounded-full bg-neutral-300" />
                        ...
                        <span className="truncate">{formatDistanceToNow(new Date(task.$createdAt))}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          <li className="hidden text-center text-sm text-muted-foreground first-of-type:block">No tasks found.</li>
            ...
            {total > 3 && (
              <Button variant="muted" className="mt-4 w-full" asChild>
                <Link href={`/workspaces/${workspaceId}/tasks`}>Show More</Link>
              </Button>
            )}
      </div>
    </div>
